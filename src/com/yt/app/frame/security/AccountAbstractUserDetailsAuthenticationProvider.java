...
package com.yt.app.frame.security;
 ...
 * this default, set the {@link #setForcePrincipalAsString} to <code>true</code>
 * .
 * <p>
 ...
 * @author Ben Alex
 */
public abstract class AccountAbstractUserDetailsAuthenticationProvider implements AuthenticationProvider, InitializingBean, MessageSourceAware {
	...
	private class DefaultPostAuthenticationChecks implements UserDetailsChecker {
		public void check(UserDetails user) {
			if (!user.isCredentialsNonExpired()) {
				throw new CredentialsExpiredException("账号授权已过期!");
			}
		}
	}
}
