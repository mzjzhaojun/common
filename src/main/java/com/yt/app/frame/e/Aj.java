...
public class Aj extends AbstractRoutingDataSource {
	...
	public Aj(Map<String, DataSource> paramMap1, Map<String, DataSource> paramMap2, Object paramObject) {
		a(paramMap1);
		b(paramMap2);
